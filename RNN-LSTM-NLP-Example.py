...
for i in range (0, numberOfLSTMLayers):
    ...
    if i == numberOfLSTMLayers - 1:
        ...
        model.add(Dropout(rate = dropOut))
model.add(Dense(1, activation='sigmoid')) #Dense dimension : 1 to N, prefer softmax if more than 2 classes. Also, for categorical variables , you can use "to_categorical" from keras.utils.np_utils.
print(model.summary())
